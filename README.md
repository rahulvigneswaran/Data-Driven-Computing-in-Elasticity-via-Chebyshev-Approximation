...
This repo consists of all the code and dataset of the research paper, **"[Data-driven computing in elasticity via Chebyshev Polynomial](https://ieeexplore.ieee.org/document/8494096)"**.
